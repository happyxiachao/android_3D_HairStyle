...
import org.andresoviedo.app.model3D.view.FaceModelActivity;
 ...
 * @author andresoviedo
 */
public class FaceSceneLoader implements LoaderTask.Callback {
     ...
     * Parent component
     */
    protected final FaceModelActivity parent;
    /**
    ...
    public FaceSceneLoader(FaceModelActivity main) {
        this.parent = main;
    }
    ...
    public void processTouch(float x, float y) {
        Log.i("processTouch","x:"+x + " y:"+y);
        FaceModelRenderer mr = parent.getGLView().getModelRenderer();
