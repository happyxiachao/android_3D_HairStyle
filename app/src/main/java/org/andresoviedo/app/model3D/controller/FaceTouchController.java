...
import org.andresoviedo.app.model3D.view.FaceModelRenderer;
import org.andresoviedo.app.model3D.view.FaceModelSurfaceView;
import org.andresoviedo.app.model3D.view.ModelRenderer;
import org.andresoviedo.app.model3D.view.ModelSurfaceView;

public class FaceTouchController {
	...
	private final FaceModelSurfaceView view;
	private final FaceModelRenderer mRenderer;
	...
	public FaceTouchController(FaceModelSurfaceView view, FaceModelRenderer renderer) {
		super();
		this.view = view;
	...
	public synchronized boolean onTouchEvent(MotionEvent motionEvent) {
		...
		if (pointerCount == 1 && simpleTouch) {
            FaceSceneLoader scene = view.getModelActivity().getScene();
