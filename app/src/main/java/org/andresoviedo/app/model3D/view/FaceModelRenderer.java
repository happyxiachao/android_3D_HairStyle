...
public class FaceModelRenderer implements GLSurfaceView.Renderer {

	private final static String TAG = FaceModelRenderer.class.getName();
    /**
	...
	private FaceModelSurfaceView main;
	// width of the screen
	private int width;
	 ...
	 *            the 3D window
	 */
	public FaceModelRenderer(FaceModelSurfaceView modelSurfaceView) throws IllegalAccessException, IOException {
...
//		GLES20.glClearColor(backgroundColor[0], backgroundColor[1], backgroundColor[2], backgroundColor[3]);
	...
	public void onDrawFrame(GL10 unused) {
		...
		try {
			...
			FaceSceneLoader scene = main.getModelActivity().getScene();
			if (scene == null) {
				// scene not ready
				return;
			}
