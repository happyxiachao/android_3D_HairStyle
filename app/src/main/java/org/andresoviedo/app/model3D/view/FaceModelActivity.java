...
import org.andresoviedo.app.model3D.demo.FaceSceneLoader;
import org.andresoviedo.app.model3D.demo.SceneLoader;
import org.andresoviedo.dddmodel2.R;
import org.andresoviedo.dddmodel2.databinding.ActivityFaceBinding;
 ...
 * @author andresoviedo
 */
public class FaceModelActivity extends Activity {
    ...
    private FaceModelSurfaceView gLView;

    private FaceSceneLoader scene;

    private Handler handler;
    ActivityFaceBinding bind;
...
//            scene = new ExampleSceneLoader(this);
            Toast.makeText(this,"paramUri is null",Toast.LENGTH_LONG).show();
            finish();
        } else {
            scene = new FaceSceneLoader(this);
        }
...
//            setContentView(gLView);
    ...
    public FaceSceneLoader getScene() {
        return scene;
    }

    public FaceModelSurfaceView getGLView() {
        return gLView;
    }
    ...
    protected void onStart() {
        super.onStart();
        bind.cameraKitView.onStart();
    }

    @Override
    protected void onResume() {
        super.onResume();
        bind.cameraKitView.onResume();
    }

    @Override
    protected void onPause() {
        bind.cameraKitView.onPause();
        super.onPause();
    }

    @Override
    protected void onStop() {
        bind.cameraKitView.onStop();
        super.onStop();
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        bind.cameraKitView.onRequestPermissionsResult(requestCode, permissions, grantResults);
    }
}
